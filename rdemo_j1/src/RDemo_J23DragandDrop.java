...
public class RDemo_J23DragandDrop extends JPanel implements ActionListener {
    ...
    private static void createAndShowGUI() {
        ...
        JComponent newContentPane = new RDemo_J23DragandDrop();
